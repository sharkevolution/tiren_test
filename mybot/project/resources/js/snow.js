...
function SnowStorm() {
  ...
  var imagePath = sitePath + 'img/'; // relative path to snow images (including trailing slash)
  ...
  var flakeRightOffset = 10; // amount to subtract from edges of container
  ...
  this.resizeHandler = function() {
    if (window.innerWidth || window.innerHeight) {
      ...
      screenY = (flakeBottom?flakeBottom:window.innerHeight - 15);
    } else {
